    ...
    var CircleAreaInstantiatorTS = _classThis = class extends _classSuper {
        ...
        instantiatePrefabs() {
            ...
            for (let i = 0; i < this.numberOfPrefabs; i++) {
                ...
                const randomPosition = new vec3(centerPosition.x + Math.cos(alpha) * distance, centerPosition.y + Math.sin(alpha) * distance, centerPosition.z + Math.sin(beta) * distance);
