...
export class CircleAreaInstantiatorTS extends BaseScriptComponent {
    ...
    private startAnimation(particle: {obj: SceneObject; pos: {x: number; y: number; z: number}}, index: number) {
        const initialDuration = this.animCycleMs / (i / this.numberOfPrefabs);
