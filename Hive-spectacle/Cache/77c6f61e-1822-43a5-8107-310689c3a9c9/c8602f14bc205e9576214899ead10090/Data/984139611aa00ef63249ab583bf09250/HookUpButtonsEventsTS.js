...
var __selfType = requireType("./HookUpButtonsEventsTS");
...
let ExampleLensManager = (() => {
    let _classDecorators = [component];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = BaseScriptComponent;
    var ExampleLensManager = _classThis = class extends _classSuper {
        constructor() {
            super();
            this.prefabToInstantiate = this.prefabToInstantiate;
            this.destinationReference = this.destinationReference;
        ...
        instantiate() {
            ...
            this.latestObject
                .getTransform()
                .setWorldPosition(this.destinationReference.getTransform().getWorldPosition());
    ...
    __setFunctionName(_classThis, "ExampleLensManager");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        ExampleLensManager = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ExampleLensManager = _classThis;
})();
exports.ExampleLensManager = ExampleLensManager;
//# sourceMappingURL=HookUpButtonsEventsTS.js.map