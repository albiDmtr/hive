...
let CircleAreaInstantiatorTS = (() => {
    ...
    var CircleAreaInstantiatorTS = _classThis = class extends _classSuper {
        ...
        animateParticle(particle) {
            ...
            let destinationPosition = originalPosition.add(new vec3(Math.random() * noiseAmplitude, Math.random() * noiseAmplitude, Math.random() * noiseAmplitude));
            LSTween_1.LSTween.moveFromToLocal(transform, startPosition, destinationPosition, this.animCycleMs)
                .easing(Easing_1.default.Linear.InOut)
                .start();
        }
