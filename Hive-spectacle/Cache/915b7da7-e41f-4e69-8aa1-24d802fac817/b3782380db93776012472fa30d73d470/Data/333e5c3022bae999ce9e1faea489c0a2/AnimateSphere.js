...
let CircleAreaInstantiatorTS = (() => {
    ...
    var CircleAreaInstantiatorTS = _classThis = class extends _classSuper {
        ...
        onStart() {
            ...
            print(`Pointcloud is ${this.sphereController.pointPositions}`);
        }
        ...
        instantiatePrefabs() {
            ...
            const particles = [];
            for (let i = 0; i < this.sphereController.numberOfPrefabs; i++) {
        ...
        startAnimation(particle, index) {
            const initialDuration = this.animCycleMs / (index / this.sphereController.numberOfPrefabs);
