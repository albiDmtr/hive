    ...
    var CircleAreaInstantiatorTS = _classThis = class extends _classSuper {
        ...
        instantiatePrefabs() {
            ...
            for (let i = 0; i < this.numberOfPrefabs; i++) {
                ...
                const randomPosition = new vec3(centerPosition.x + Math.sin(alpha) * Math.cos(beta) * distance, centerPosition.y + Math.sin(beta) * Math.cos(alpha) * distance, centerPosition.z + Math.cos(alpha) * distance);
